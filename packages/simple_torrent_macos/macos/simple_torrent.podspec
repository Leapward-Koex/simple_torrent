...
Pod::Spec.new do |s|
  ...
  s.version          = '1.0.0'
  s.summary          = 'macOS implementation of the simple_torrent plugin.'
  s.description      = <<-DESC
macOS implementation of the simple_torrent plugin using libtorrent.
                       DESC
  s.homepage         = 'https://github.com/Leapward-Koex/simple_torrent'
  s.license          = { :file => '../LICENSE' }
  s.author           = { 'Leapward-Koex' => 'email@example.com' }
